...
public class NpcViewMod implements IBypassHandler
{
	...
	private static String getDropListButtons(Npc npc)
	{
		...
		if ((dropListGroups != null) || (dropListDeath != null))
		{
			...
			if ((dropListGroups != null) || (dropListDeath != null))
			{
				sb.append("<td align=center><button value=\"Droplist\" width=260 height=33 action=\"bypass NpcViewMod dropList DROP " + npc.getObjectId() + "\" back=\"L2UI_CT1.HtmlWnd_BTN02High_down\" fore=\"L2UI_CT1.HtmlWnd_BTN02High\"></td>");
			}
			sb.append("</tr></table>");
		}
		return sb.toString();
