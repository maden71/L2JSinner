...
public class TeleportCube implements IItemHandler
{
	...
	private static final Location SILVAN_TELEPORT = new Location(-117527, 249026, -1948);
	private static final Location KALLESIN_TELEPORT = new Location(7756, 184936, -2488);
	private static final Location ZENATH_TELEPORT = new Location(-74584, 168523, -3498);
	...
	private static final Location QS_TELEPORT = new Location(-107919, 248780, -3226);
	private static final Location QS_TELEPORT2 = new Location(-113643,246025,-3700);
	private static final Location QS1_TELEPORT1 = new Location(7756, 184936, -2488);
	private static final Location QS1_TELEPORT2 = new Location(-74554, 168448, -3504);
	private static final Location QS1_TELEPORT3 = new Location(-69650, 170568, -3486);
