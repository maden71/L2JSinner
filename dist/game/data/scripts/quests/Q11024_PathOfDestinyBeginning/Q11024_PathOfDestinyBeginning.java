...
public class Q11024_PathOfDestinyBeginning extends Quest
{
	...
	//new
	private static final Location TALKING_ISLAND_FIELD = new Location(-107919, 248780, -3226);
	private static final Location TALKING_ISLAND_PATHS = new Location(-113643,246025,-3700);
	...
	public Q11024_PathOfDestinyBeginning()
	{
		...
		addKillId(WOLF, HONEYBEE, ELDER_FOX, ORC_SNIPER, ORC_WARRIOR);
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			case "teleport1":
			{
				if (qs.isCond(3))
				{
					player.teleToLocation(TALKING_ISLAND_FIELD);
				}
				break;
			}
			case "teleport2":
			{
				if (qs.isCond(6))
				{
					player.teleToLocation(TALKING_ISLAND_PATHS);
				}
				break;
			}
			case "shotsreward":
