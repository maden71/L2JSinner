...
public class Q10591_NobleMaterial extends Quest
{
	...
	private static final int EXALTED_HEAVY_ARMOR_PACK = 81647;
	private static final int EXALTED_LIGHT_ARMOR_PACK = 81648;
	private static final int EXALTED_ROBE_PACK = 81649;
	...
	private static final Location Genesis = new Location(207968,112199,-2053);
	...
	public void actionForEachPlayer(Player player, Npc npc, boolean isSummon)
	{
		...
		if ((qs != null) && qs.isCond(2) && Util.checkIfInRange(Config.ALT_PARTY_RANGE, npc, player, false))
		{
			...
			{
				giveItems(player, FLAME_ENERGY, 10);
